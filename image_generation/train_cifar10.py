...
def main(args):
    ...
    if rank == 0:
        ...
        model_string_name = args.model.replace("/", "-")  # e.g., (for naming folders)
    ...
    # Note that parameter initialization is done within the FoD constructor
    ...
    dataset = CIFAR10(root=args.data_path, train=True,
    ...
    for epoch in range(args.epochs):
        ...
        for x, y in loader:
            ...
            model_kwargs = dict(y=y) if num_classes is not None else dict()
...
if __name__ == "__main__":
    ...
    parser.add_argument("--data-path", type=str, default='/home/ziwlu/datasets/cifar10')
    parser.add_argument("--results-dir", type=str, default="results/cifar10")
